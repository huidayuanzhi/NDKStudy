...
JNIEXPORT void JNICALL Java_com_example_testndkeclipse_JniClient_TestDataTypeJ2C
        (JNIEnv *, jclass, jshort, jint, jlong, jfloat, jdouble, jchar, jboolean, jbyte, jstring,
         jintArray, jobject, jobject);
...
JNIEXPORT jobject JNICALL Java_com_cheng_ndkstudy_JniClient_getObjectFromC
